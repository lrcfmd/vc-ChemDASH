...
@pytest.mark.parametrize(
    "gulp_keywords, gulp_options, gulp_shells, gulp_library, gulp_conditions, expected_output",
    [
        (
            "opti lbfgs conp c6",
            ["library STO.lib", "time 10 minutes"],
            [],
            "STO.lib",
            None,
            (
...
def test_run_gulp(
    ...
    monkeypatch.setattr(
        chemdash.gulp_calc, "read_outcome", lambda x: "Optimisation Achieved"
    )
    monkeypatch.setattr(chemdash.gulp_calc, "check_timed_out", lambda x: False)

    output = chemdash.gulp_calc.run_gulp(
        STO_atoms, "gulp", "", gulp_keywords, gulp_options, gulp_shells, gulp_library
    )

    assert output == expected_output
    assert STO_atoms.get_calculator() == Gulp(
        filename="gulp",
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "test_gulp_output, expected_output",
    [
        (
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "energy, test_gulp_restart, expected_output",
    [
        (
            -158.5,
            """
...
def test_update_atoms_from_restart_file(
    STO_atoms, energy, test_gulp_restart, expected_output, monkeypatch
):
    """
    ...
    assert (
        chemdash.gulp_calc.update_atoms_from_restart_file(STO_atoms, energy, "")
        == expected_output
    )
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "test_res_file, unit_cell, gulp_keywords, gulp_options, gulp_library, expected_output",
    [
        (
            [
                "#",
...
def test_create_input_file_from_restart_file(
    test_res_file,
    unit_cell,
    gulp_keywords,
    gulp_options,
    ...
    monkeypatch.setattr(
        chemdash.gulp_calc, "read_restart_file", lambda x: test_res_file
    )
    ...
    chemdash.gulp_calc.create_input_file_from_restart_file(
        "", "", unit_cell, gulp_keywords, gulp_options, gulp_library
    )
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "test_gulp_output, gulp_keywords, expected_output",
    [
...
def test_check_convergence(
    test_gulp_output, gulp_keywords, expected_output, monkeypatch
):
    """
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "test_final_lines,  expected_output",
    [
        (
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "new_outcome, outcome_dict, expected_output",
    [
        ("Optimisation Achieved", {}, {"Optimisation Achieved": 1}),
        (
            "Timed out in GULP",
            {"Optimisation Achieved": 2, "Too many failed attempts to optimise": 1},
            {
                "Optimisation Achieved": 2,
                "Too many failed attempts to optimise": 1,
                "Timed out in GULP": 1,
            },
        ),
        (
...
def test_update_outcomes(new_outcome, outcome_dict, expected_output):
    ...
    assert (
        chemdash.gulp_calc.update_outcomes(new_outcome, outcome_dict) == expected_output
    )
...
@pytest.mark.parametrize(
    ...
    """,
            (
                ...
                [
                    0.001063178724392094,
                    0.001825279430662604,
                    0.00068632790996724,
                    0.0013381229390455871,
                    0.0010154659029233822,
                ],
            ),
        ),
        (
...
def test_determine_vacancy_positions(STOX_structure, expected_output):
    ...
    assert all(
        [
            np.allclose(x, y)
            for x, y in zip(
                chemdash.gulp_calc.determine_vacancy_positions(STOX_structure),
                expected_output,
            )
        ]
    )
...
def test_populate_points_with_vacancies(STO_atoms, vacancy_points, STOX_structure):
    ...
    assert (
        chemdash.gulp_calc.populate_points_with_vacancies(STO_atoms, vacancy_points)
        == STOX_structure
    )
