...
def test_params(scope="module"):
    ...
    return {
        "calculator": {"value": "gulp", "specified": False},
...
def test_write_defaults_to_file(test_params, expected_output, monkeypatch):
    ...
    monkeypatch.setattr(
        chemdash.inputs, "initialise_default_params", lambda x: test_params
    )
            ...
            (
                {
                    ...
                    "gulp_keywords": {"value": "opti, pot", "specified": False},
                    "gulp_options": {
                        "value": "time 10 minutes, stepmax 0.5",
                        "specified": True,
                    },
                },
                [],
    ...
    [
        (
            ...
            [
                ...
                mock.call(
                    '\tERROR in input file "" -- The keyword(s) temp:0.01, foo are invalid.\n'
                ),
                mock.call(
                    '\tERROR in input file "" -- "grid_points" is 5, but should be an even integer.\n'
                ),
                mock.call(
                    '\tERROR in input file "" -- "calculator" is castep, but should only be one of the supported values: gulp, vasp\n'
                ),
            ],
        )
    ],
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "keyword, value, errors, list_output, expected_output",
    [
        ("temp", "0", [], (), (0.0, [])),
        ("temp", "1", [], (), (1.0, [])),
        ("temp", "4", [], (), (4.0, [])),
        ...
        (
            ...
            [],
            (),
            (-4.0, ['"temp" is -4.0, but should be a positive number.']),
        ),
        (
            "temp",
            "foobar",
            [],
            (),
            ("foobar", ['"temp" is foobar, but should be a positive number.']),
        ),
        (
            "temp",
            "['4', '4', '4']",
            ...
            (
                "['4', '4', '4']",
                ["\"temp\" is ['4', '4', '4'], but should be a positive number."],
            ),
        ),
...
def test_check_positive_float(
    keyword, value, errors, list_output, expected_output, monkeypatch
):
    """
    ...
    monkeypatch.setattr(
        chemdash.inputs, "check_list_positive_float", lambda x, y, z: list_output
    )

    assert (
        chemdash.inputs.check_positive_float(keyword, value, errors) == expected_output
    )


# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "keyword, value, errors, expected_output",
    [
        (
            "temp",
            "foobar",
            [],
            ("foobar", ['"temp" is foobar, but all values should be positive floats.']),
        ),
        (
            "temp",
            "['4', '4', '4']",
            ...
            (
                "['4', '4', '4']",
                [
                    "\"temp\" is ['4', '4', '4'], but all values should be positive floats."
                ],
            ),
        ),
        ...
        (
            ...
            (
                [4.0, -4.0, 4.0],
                [
                    '"temp" is [4.0, -4.0, 4.0], but all values should be positive floats.'
                ],
            ),
        ),
        (
            ...
            (
                [1.0, -2.0, 3.0],
                [
                    '"temp" is [1.0, -2.0, 3.0], but all values should be positive floats.'
                ],
            ),
        ),
    ],
)
def test_check_list_positive_float(
    keyword, value, errors, expected_output, monkeypatch
):
    """
    ...
    assert (
        chemdash.inputs.check_list_positive_float(keyword, value, errors)
        == expected_output
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [],
            (),
            ("4.0", ['"grid_points" is 4.0, but should be a positive integer.']),
        ),
        (
            "grid_points",
            "3.5",
            [],
            (),
            ("3.5", ['"grid_points" is 3.5, but should be a positive integer.']),
        ),
        (
            "grid_points",
            "-4",
            [],
            (),
            (-4, ['"grid_points" is -4, but should be a positive integer.']),
        ),
        (
            "grid_points",
            "foobar",
            [],
            (),
            ("foobar", ['"grid_points" is foobar, but should be a positive integer.']),
        ),
        (
            "grid_points",
            "['4', '4', '4']",
            ...
            (
                "['4', '4', '4']",
                [
                    "\"grid_points\" is ['4', '4', '4'], but should be a positive integer."
                ],
            ),
        ),
...
def test_check_positive_int(
    ...
    monkeypatch.setattr(
        chemdash.inputs, "check_list_positive_int", lambda x, y, z: list_output
    )
    ...
    [
        (
            ...
            (
                "foobar",
                [
                    '"grid_points" is foobar, but all values should be positive integers.'
                ],
            ),
        ),
        (
            ...
            (
                "['4', '4', '4']",
                [
                    "\"grid_points\" is ['4', '4', '4'], but all values should be positive integers."
                ],
            ),
        ),
        ...
        (
            ...
            (
                ["3.5", "3.5", "3.5"],
                [
                    "\"grid_points\" is ['3.5', '3.5', '3.5'], but all values should be positive integers."
                ],
            ),
        ),
        (
        ...
        (
            ...
            (
                [1, -2, 3],
                [
                    '"grid_points" is [1, -2, 3], but all values should be positive integers.'
                ],
            ),
        ),
    ],
...
def test_check_list_positive_int(keyword, value, errors, expected_output, monkeypatch):
    ...
    assert (
        chemdash.inputs.check_list_positive_int(keyword, value, errors)
        == expected_output
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            [],
            (),
            (1, ['"grid_points" is 1, but should be an even integer.']),
        ),
        ("grid_points", "4", [], (), (4, [])),
        (
            "grid_points",
            ...
            [],
            (),
            ("4.0", ['"grid_points" is 4.0, but should be an even integer.']),
        ),
        (
            "grid_points",
            "3.5",
            [],
            (),
            ("3.5", ['"grid_points" is 3.5, but should be an even integer.']),
        ),
        ("grid_points", "-4", [], (), (-4, [])),
        (
            "grid_points",
            ...
            [],
            (),
            ("foobar", ['"grid_points" is foobar, but should be an even integer.']),
        ),
        (
            "grid_points",
            "['4', '4', '4']",
            ...
            (
                "['4', '4', '4']",
                ["\"grid_points\" is ['4', '4', '4'], but should be an even integer."],
            ),
        ),
        ("grid_points", ["4", "4", "4"], [], ([4, 4, 4], []), ([4, 4, 4], [])),
    ],
)
def test_check_even_int(
    keyword, value, errors, list_output, expected_output, monkeypatch
):
    """
    GIVEN an input keyword and value.
    ...
    monkeypatch.setattr(
        chemdash.inputs, "check_list_even_int", lambda x, y, z: list_output
    )
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            (
                "foobar",
                ['"grid_points" is foobar, but all values should be even integers.'],
            ),
        ),
        (
            "grid_points",
            ...
            (
                "['4', '4', '4']",
                [
                    "\"grid_points\" is ['4', '4', '4'], but all values should be even integers."
                ],
            ),
        ),
        (
            ...
            (
                [1, 1, 1],
                ['"grid_points" is [1, 1, 1], but all values should be even integers.'],
            ),
        ),
        ("grid_points", ["4", "4", "4"], [], ([4, 4, 4], [])),
        (
            ...
            (
                ["3.5", "3.5", "3.5"],
                [
                    "\"grid_points\" is ['3.5', '3.5', '3.5'], but all values should be even integers."
                ],
            ),
        ),
        ("grid_points", ["4", "-4", "4"], [], ([4, -4, 4], [])),
        (
            ...
            (
                [1, -2, 3],
                [
                    '"grid_points" is [1, -2, 3], but all values should be even integers.'
                ],
            ),
        ),
    ],
...
def test_check_list_even_int(keyword, value, errors, expected_output, monkeypatch):
    ...
    assert (
        chemdash.inputs.check_list_even_int(keyword, value, errors) == expected_output
    )


# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "keyword, value, errors, allowed_ints, expected_output",
    [
        ...
        (
            ...
            (
                4,
                ['"seed_bits" is 4, but should be one of the supported values: 32, 64'],
                False,
            ),
        ),
        (
            ...
            (
                "64.0",
                [
                    '"seed_bits" is 64.0, but should be one of the supported values: 32, 64'
                ],
                False,
            ),
        ),
        (
            ...
            (
                "3.5",
                [
                    '"seed_bits" is 3.5, but should be one of the supported values: 32, 64'
                ],
                False,
            ),
        ),
        (
            ...
            (
                "foobar",
                [
                    '"seed_bits" is foobar, but should be one of the supported values: 32, 64'
                ],
                False,
            ),
        ),
...
def test_check_int_on_list(keyword, value, errors, allowed_ints, expected_output):
    ...
    assert (
        chemdash.inputs.check_int_on_list(keyword, value, errors, allowed_ints)
        == expected_output
    )
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "keyword, value, errors, bits, expected_output",
    [
        ("random_seed", "0", [], 32, (0, [])),
        (
            "random_seed",
            ...
            [],
            32,
            (-12, ['"random_seed" is -12, but should be an unsigned 32-bit integer.']),
        ),
        ...
        (
            ...
            (
                4294967296,
                [
                    '"random_seed" is 4294967296, but should be an unsigned 32-bit integer.'
                ],
            ),
        ),
        ...
        (
            ...
            (
                "foobar",
                ['"random_seed" is foobar, but should be an unsigned 64-bit integer.'],
            ),
        ),
    ],
)
def test_check_unsigned_n_bit_int(keyword, value, errors, bits, expected_output):
    ...
    assert (
        chemdash.inputs.check_unsigned_n_bit_int(keyword, value, errors, bits)
        == expected_output
    )
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "keyword, value, errors, allowed_strings, expected_output",
    [
        ...
        (
            ...
            (
                "foobar",
                [
                    '"verbosity" is foobar, but should only be one of the supported values: terse, verbose'
                ],
                False,
            ),
        ),
...
def test_check_str_on_list(keyword, value, errors, allowed_strings, expected_output):
    ...
    assert (
        chemdash.inputs.check_str_on_list(keyword, value, errors, allowed_strings)
        == expected_output
    )
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            (["cations", "atoms", "all"], [], True),
        ),
        (
            "old_swap_groups",
            ["cations", "atoms", "foobar"],
            [],
            ["cations", "anions", "atoms", "all"],
            (
                ["cations", "atoms", "foobar"],
                [
                    '"old_swap_groups" contains foobar, but should only contain the supported values: cations, anions, atoms, all'
                ],
                False,
            ),
        ),
        (
            ...
            (
                ["foo", "bar"],
                [
                    '"old_swap_groups" contains foo, but should only contain the supported values: cations, anions, atoms, all',
                    '"old_swap_groups" contains bar, but should only contain the supported values: cations, anions, atoms, all',
                ],
                False,
            ),
        ),
...
def test_check_str_list_on_list(
    keyword, value, errors, allowed_strings, expected_output
):
    """
    ...
    assert (
        chemdash.inputs.check_str_list_on_list(keyword, value, errors, allowed_strings)
        == expected_output
    )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "y",
            [],
            ("y", ['"restart" is y, but should be "True" or "False".']),
        ),
        (
            "restart",
            "n",
            [],
            ("n", ['"restart" is n, but should be "True" or "False".']),
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            ["cations", "anions", "atoms", "all"],
            [],
            (["cations", "anions", "atoms", "all"], [], True),
        ),
        (
            "swap_groups",
            ["cations", "atoms", "atoms", "all"],
            [],
            (
                ["cations", "atoms", "atoms", "all"],
                [
                    '"swap_groups" contains atoms more than once, but each item in this list should only appear once.'
                ],
                False,
            ),
        ),
        (
            "swap_groups",
            ["cations", "cations", "all", "all"],
            [],
            (
                ["cations", "cations", "all", "all"],
                [
                    '"swap_groups" contains cations more than once, but each item in this list should only appear once.',
                    '"swap_groups" contains all more than once, but each item in this list should only appear once.',
                ],
                False,
            ),
        ),
...
def test_check_duplicates_in_list(keyword, value, errors, expected_output):
    ...
    assert (
        chemdash.inputs.check_duplicates_in_list(keyword, value, errors)
        == expected_output
    )
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "swap_groups, errors, main_swap_groups, expected_output",
    [
        (
            [["cations"], ["anions"], ["atoms"], ["all"]],
            [],
        ...
        (
            ...
            (
                [["Sr:X"], ["O:Ti"]],
                [
                    '"swap_groups" contains "Sr:X", which is not a valid swap group. The main swap groups are "cations", "anions", "atoms", "all", and custom swap groups should be in the format "[Chemical Symbol]-[Chemical Symbol]-[Chemical Symbol] . . .", with each chemical symbol appearing only once.',
                    '"swap_groups" contains "O:Ti", which is not a valid swap group. The main swap groups are "cations", "anions", "atoms", "all", and custom swap groups should be in the format "[Chemical Symbol]-[Chemical Symbol]-[Chemical Symbol] . . .", with each chemical symbol appearing only once.',
                ],
                False,
            ),
        ),
        (
            ...
            (
                [["Sr-"], ["X-Sr-X"], ["O:T"]],
                [
                    '"swap_groups" contains "Sr-", which is not a valid swap group. The main swap groups are "cations", "anions", "atoms", "all", and custom swap groups should be in the format "[Chemical Symbol]-[Chemical Symbol]-[Chemical Symbol] . . .", with each chemical symbol appearing only once.',
                    '"swap_groups" contains "X-Sr-X", which is not a valid swap group. The main swap groups are "cations", "anions", "atoms", "all", and custom swap groups should be in the format "[Chemical Symbol]-[Chemical Symbol]-[Chemical Symbol] . . .", with each chemical symbol appearing only once.',
                    '"swap_groups" contains "O:T", which is not a valid swap group. The main swap groups are "cations", "anions", "atoms", "all", and custom swap groups should be in the format "[Chemical Symbol]-[Chemical Symbol]-[Chemical Symbol] . . .", with each chemical symbol appearing only once.',
                ],
                False,
            ),
        ),
...
def test_check_swap_groups_valid(
    swap_groups, errors, main_swap_groups, expected_output
):
    """
    ...
    assert (
        chemdash.inputs.check_swap_groups_valid(swap_groups, errors, main_swap_groups)
        == expected_output
    )
    ...
    [
        ...
        (
            ...
            (
                ["2", "4", "6", "8"],
                [
                    '"grid_points" should be a list of up to three values, but 4 values have been supplied.'
                ],
            ),
        ),
    ],
...
def test_convert_to_three_element_list(test_list, expected_output):
    ...
    assert (
        chemdash.inputs.convert_to_three_element_list("grid_points", test_list, [])
        == expected_output
    )
...
def test_convert_to_dict_with_yaml(test_dict, expected_output):
    ...
    assert (
        chemdash.inputs.convert_to_dict_with_yaml("", test_dict, []) == expected_output
    )
