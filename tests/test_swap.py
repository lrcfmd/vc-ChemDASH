...
def test_reduce_structure(STOX_structure, atom_filter, expected_output):
    ...
    structure = chemdash.swap.reduce_structure(STOX_structure.atoms, atom_filter)
...
# ===========================================================================================================================================================
@pytest.mark.parametrize(
    "swap_list, ranking_dict, directed_num_atoms, predefined_vacancies, vacancy_exclusion_radius, force_vacancy_swaps",
    [
...
def test_swap_atoms(
    ...
    old_positions = STOX_structure.atoms.get_scaled_positions()
    new_positions = swapped_atoms.get_scaled_positions()
    ...
    for i in range(len(STOX_structure.atoms)):
