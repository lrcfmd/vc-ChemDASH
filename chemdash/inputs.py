...
def initialise_default_params(calc_name):
    ...
    params = {
        "atoms_file": {
            "value": calc_name + ".atoms",
            "specified": False,
            "type": "string",
            "description": "File in which the species, number and oxidation state of the atoms used in "
            "this calculation are specified.",
        },
        "atom_rankings": {
            "value": "random",
            "specified": False,
            "supported_values": ["random", "bvs", "bvs+", "site_pot"],
            "type": "string on list",
            "description": 'The metric used to rank atoms for swapping. Supported values are: "random" '
            '(default), "bvs", "bvs+", "site_pot". Note that site potential and bvs+ '
            "directed swapping are only supported for gulp.",
        },
        "bvs_dopant_atoms": {
            "value": [],
            "specified": False,
            "type": "list",
            "description": "A pool of atoms to be doped into the structure with bvs method",
        },
        "bvs_dopant_atoms_charges": {
            "value": [],
            "specified": False,
            "type": "list",
            "description": "A list of charges of atoms to be doped into the structure with"
            " bvs method",
        },
        "bvs_file": {
            "value": calc_name + "_bvs.dat",
            "specified": False,
            "type": "string",
            "description": "Raw Bond Valence Sum file for this calculation. Records the bond valence sum for "
            "the atoms in each structure.",
        },
        "calculator": {
            "value": "gulp",
            "specified": False,
        ...
        "calculator_time_limit": {
            ...
            "specified": False,
            "type": "integer",
            "description": 'Used in the bash "timeout" command, GULP calculations will '
            "automatically terminate after this amount of time has expired.",
        },
        "cell_spacing": {
            "value": "2.0",
            "specified": False,
        ...
        "converge_first_structure": {
            "value": "True",
            "specified": False,
            "type": "boolean",
            "description": "If True, abort the run if the initial structure is not "
            "converged. Default: True",
        },
        # "convex_hull_file": {"value": "", "specified": False, "type": "str","description": 'If specified, the energy difference is taken as the difference in energy' 'between structures relative to the convex hull. Default: None'},
        "cp_2d_lattice": {
            "value": "oblique",
            "specified": False,
            "supported_values": ["oblique", "centred_rectangular"],
            "type": "string on list",
            "description": "Lattice type for anion layers in close packed grids. Supported values are: "
            '"oblique" (default) and "centred_rectangular"',
        },
        "cp_stacking_sequence": {
            "value": "",
            "specified": False,
        ...
        "directed_num_atoms": {
            ...
            "specified": False,
            "type": "integer",
            "description": "For directed swapping, the number of extra atoms available to choose "
            "between from the top of the list for each species. Default: 0",
        },
        "directed_num_atoms_increment": {
            "value": 0,
            "specified": False,
            "type": "integer",
            "description": "For directed swapping, the amount by which to increase ("
            "decrease) the number of extra values available to choose "
            "between from the top of the list for each species when a "
            "structure is (not) repeated. Default: 0",
        },
        "dopable_atoms": {
            "value": [],
            "specified": False,
            "type": "list",
            "description": "A list of species that are available for doping in the solid solution routine",
        },
        "doping_threshold": {
            "value": 0,
            "specified": False,
            "type": "float",
            "description": "The threshold which defines the time averaged proportion of dopes over "
            "swaps. Default: 0.1",
        },
        "energy_file": {
            "value": calc_name + "_energy.dat",
            "specified": False,
            "type": "string",
            "description": "Energy file for this calculation. Records the structure number, energies and "
            "volumes of accepted structures.",
        },
        "energy_step_file": {
            "value": calc_name + "_energy_step.dat",
            "specified": False,
            "type": "string",
            "description": "Energy step file for this calculation. Records the structure number, "
            "energies and volumes of accepted structures for plotting.",
        },
        "force_vacancy_swaps": {
            "value": "True",
            "specified": False,
            "type": "boolean",
            "description": "If True, vacancies cannot swap with each other, they must be replaced "
            "by atoms. Default: True.",
        },
        "grid_points": {
            "value": "2",
            "specified": False,
            "type": "integer",
            "description": "The number of points on each dimension of the ANION grid, to form an a x b x "
            "c grid for anions (cation points defined by grid type). Default: 2x2x2",
        },
        "grid_type": {
            "value": "orthorhombic",
            "specified": False,
            ...
            "type": "string on list",
            "description": 'Initial layout of cation and anion grids. Supported values are "orthorhombic" ('
            'default), rocksalt", close_packed". Default: "orthorhombic".',
        },
        "gulp_executable": {
            "value": "gulp",
            "specified": False,
        ...
        "gulp_keywords": {
            ...
            "specified": False,
            "type": "list to string",
            "description": 'Comma-separated list of keywords for all GULP calculations. Default: "opti, '
            'pot"',
        },
        "gulp_calc_1_keywords": {
            "value": "",
            "specified": False,
            "type": "list to string",
            "description": "Comma-separated list of keywords for first GULP calculation. "
            "Default: None",
        },
        "gulp_calc_2_keywords": {
            "value": "",
            "specified": False,
            "type": "list to string",
            "description": "Comma-separated list of keywords for second GULP calculation. "
            "Default: None",
        },
        "gulp_calc_3_keywords": {
            "value": "",
            "specified": False,
            "type": "list to string",
            "description": "Comma-separated list of keywords for third GULP calculation. Default: None",
        },
        "gulp_calc_4_keywords": {
            "value": "",
            "specified": False,
            "type": "list to string",
            "description": "Comma-separated list of keywords for fourth GULP calculation. Default: None",
        },
        "gulp_calc_5_keywords": {
            "value": "",
            "specified": False,
            "type": "list to string",
            "description": "Comma-separated list of keywords for fifth GULP calculation. Default: None",
        },
        "gulp_calc_1_max_gnorm": {
            "value": "",
            "specified": False,
        ...
        "gulp_calc_2_max_gnorm": {
            "value": "",
            "specified": False,
            "type": "float specified",
            "description": "If specified, terminate a GULP calculation if the final gnorm exceeds this value after the second stage.",
        },
        "gulp_calc_3_max_gnorm": {
            "value": "",
            "specified": False,
            "type": "float specified",
            "description": "If specified, terminate a GULP calculation if the final gnorm "
            "exceeds this value after the third stage.",
        },
        "gulp_calc_4_max_gnorm": {
            "value": "",
            "specified": False,
            "type": "float specified",
            "description": "If specified, terminate a GULP calculation if the final gnorm "
            "exceeds this value after the fourth stage.",
        },
        "gulp_calc_5_max_gnorm": {
            "value": "",
            "specified": False,
            "type": "float specified",
            "description": "If specified, terminate a GULP calculation if the final gnorm "
            "exceeds this value after the fifth stage.",
        },
        "gulp_library": {
            "value": "",
            "specified": False,
            "type": "string",
            "description": "Library file containing the forcefield to be used in GULP calculations. NOTE "
            '-- this takes precedence over a library specified in "gulp_options".',
        },
        "gulp_options": {
            "value": [],
            "specified": False,
        ...
        "ionic_convergence_steps": {
            "value": 1,
            "specified": False,
            "type": "integer",
            "description": "Integer defining the minimum number of ionic convergence steps"
        ...
        "initial_mag_moments": {
            ...
            "specified": False,
            "type": "string",
            "description": "List of initial magnetic moments for a spin-polarised run",
        },
        ...
        "keep_mag_structure_constant": {
            "value": "False",
            "specified": False,
            "type": "boolean",
            "description": "If True, magnetic structure for each optimisation is kept constant across crystal positions",
        },
        "max_structures": {
            "value": 10,
            "specified": False,
            "type": "integer",
            "description": "This run of the code will terminate after this number of structures have "
            "been considered in this and all previous runs.",
        },
        "neighbourhood_atom_distance_limit": {
            "value": 1.0,
            "specified": False,
            "type": "float",
            "description": "The minimum distance allowed between atoms in the local "
            "combinatorial neighbourhood method. Default: 1.0",
        },
        "nth_doping_step": {
            "value": 0,
            "specified": False,
        ...
        "num_neighbourhood_points": {
            "value": 1,
            "specified": False,
            "type": "integer",
            "description": "The number of points used along each axis in the local "
            "combinatorial neighbourhood method. Default: 1",
        },
        "num_structures": {
            "value": 10,
            "specified": False,
        ...
        "number_weightings": {
            ...
            "type": "string on list",
            "description": "The method used to construct the weightings used to choose the number "
            'of atoms to swap. Supported values are "arithmetic" (default), '
            '"geometric", "uniform", and "pinned_pair".',
        },
        "output_file": {
            "value": calc_name + ".chemdash",
            "specified": False,
            "type": "string",
            "description": "Output file for this calculation. Records the swaps for each structure, "
            "energies and acceptances.",
        },
        "output_trajectory": {
            "value": "True",
            "specified": False,
        ...
        "pair_weighting": {
            ...
            "specified": False,
            "type": "float",
            "description": "The initial proportional probability of swapping 2 atoms compared to any "
            'other number when using the "pinned_pair" option for "number_weightings". '
            "Default: 1.0",
        },
        "pair_weighting_scale_factor": {
            ...
            "specified": False,
            "type": "float",
            "description": "The factor by which we increase the proportional probability "
            "of swapping 2 atoms compared to any other number when we "
            "explore new basins (we decrease by the inverse factor for "
            'repeated basins) when using the "pinned_pair" option for '
            '"number_weightings". Default: 1.0',
        },
        "position_tolerance": {
            "value": 1e-2,
            "specified": False,
            "type": "float",
            "description": "Defines the tolerance to which a new structure is determined "
            "to be "
            "equal to a previous structure."
            "Smaller values give a tighter tolerance and fewer structures are"
            "considered equivalent. Default: 1E-2",
        },
        "potentials_file": {
            "value": calc_name + "_potentials.dat",
            "specified": False,
            "type": "string",
            "description": "Potentials file for this calculation. Records the site potentials for each structure.",
        },
        "potential_derivs_file": {
            "value": calc_name + "_derivs.dat",
            "specified": False,
            "type": "string",
        ...
        "random_dopant_atoms": {
            ...
            "specified": False,
            "type": "list",
            "description": "A pool of dopants to be randomly doped into the structure at random places",
        },
        "random_seed": {
            "value": 42,
            "specified": False,
        ...
        "run_method": {
            ...
            "specified": False,
            "type": "string",
            "description": 'Determines the shell method for running VASP or GULP. Options are "srun" '
            'or "mpirun". Default: "mpirun"',
        },
        "save_outcar": {
            "value": "False",
            "specified": False,
        ...
        "solid_solution_end_members": {
            "value": "",
            "specified": False,
            "type": "dictionary",
            "description": "Entries of end members of the solid solution in the form "
            "species: energy",
        },
        "swap_groups": {
            "value": "cations,anions,atoms,all",
            "specified": False,
            "supported_values": [
                "cations",
                "anions",
            ...
            "type": "list of lists",
            "description": "The groups of atoms that can be involved in swaps. The default groups are: "
            '"cations", "anions", "atoms", and "all" (atoms and vacancies). The input can '
            'include these, the additional swap group "atoms-vacancies" (always swap atoms '
            "with vacancies), or any custom swap group in the format [Chemical Symbol]-["
            'Chemical Symbol]-[Chemical Symbol]. . . e.g., "Sr-X". A weighting can also be '
            'specified for each group as follows: "cations:1, atoms:2, all:3".',
        },
        "swap_magnetic_moments": {
            "value": "False",
            "specified": False,
            "type": "boolean",
            "description": "If True, the magnetic moments are swapped while atomic positions are "
            "held constant",
        },
        "testing": {
            "value": "False",
            "specified": False,
            "type": "boolean",
            "description": "If True, no optimisation calculations are run",
        },
        "temp": {
            "value": 0.0,
            "specified": False,
        ...
        "vasp_max_convergence_calcs": {
            "value": 10,
            "specified": False,
            "type": "integer",
            "description": "Maximum number of VASP calculations performed in the final "
            "stage for convergence -- we abandon the calculation after "
            "this. Default: 10.",
        },
        "vasp_pp_dir": {
            "value": ".",
        ...
        "verbosity": {
            ...
            "type": "string on list",
            "description": 'Controls the level of detail in the output. Valid options are: "verbose", '
...
# =============================================================================
def parse_input(input_file: str, calc_name: str) -> Tuple[dict, str]:
    ...
    Parameters
    ----------
    input_file : string/dict
        Name of input file for this run of the code or a dictionary of keywords.
    calc_name : string
        Name of this job -- default value for name of atoms file.
    ...
    with open(input_file, mode="r") as in_file:
        ...
        file_contents[:] = [
            x for x in file_contents if not x.startswith(("#", "!", "\n"))
        ]
        ...
        if len(invalid_keywords) > 0:
            errors.append(
                "The keyword(s) {0} are invalid.".format(", ".join(invalid_keywords))
            )
...
def report_input_file_errors(errors, input_file, error_file):
    ...
    with open(error_file, mode="a") as error_log:
        error_log.write(
            '{0:d} errors were found in the input file: "{1}"\n'.format(
...
def convert_values(params, errors):
    ...
    for key in three_element_list_keys:
        params[key]["value"], errors = convert_to_three_element_list(
            key, params[key]["value"], errors
        )
    ...
    for key, option in params.items():
        ...
        if option["type"] == "boolean":
            ...
            option["value"], errors = convert_to_dict_with_yaml(
                key, option["value"], errors
            )
            ...
            option["value"], errors, _ = check_int_on_list(
                key, option["value"], errors, option["supported_values"]
            )
            ...
            if option["specified"]:
                option["value"], errors = check_positive_float(
                    key, option["value"], errors
                )
            ...
            try:
                option["value"] = [
                    entry.strip() for entry in option["value"].split(",")
                ]
            ...
            option["value"] = [
                entry.strip().split(":") for entry in option["value"].split(",")
            ]
            ...
            option["value"], errors, _ = check_str_on_list(
                key, option["value"], errors, option["supported_values"]
            )

        elif option["type"] == "string list on list":
            option["value"], errors, _ = check_str_list_on_list(
                key, list(option["value"].upper()), errors, option["supported_values"]
            )
        elif option["type"] == "tuple of tuples":
            print([option["value"][0]])
            continue
        else:
            errors.append(
                "The keyword {0} has the type ({1}, which is not a valid type.".format(
                    key, option["type"]
                )
            )

    # convert magnetic moments to correct type
    if params["initial_mag_moments"]["specified"]:
        params["initial_mag_moments"]["value"] = multiply_out_moments(
            params["initial_mag_moments"]["value"]
        )
...
def handle_dependencies(params, errors):
    ...
    swap_groups, errors, swap_groups_valid = check_duplicates_in_list(
        "swap_groups", swap_groups, errors
    )

    params["swap_groups"]["value"], errors, swap_groups_valid = check_swap_groups_valid(
        params["swap_groups"]["value"],
        errors,
    ...
    if params["num_structures"]["value"] > params["max_structures"]["value"]:
        errors.append(
            '"num_structures" should not be larger than "max_structures". "num_structures" is {0:d} and "max_structures" is {1:d}.'.format(
                params["num_structures"]["value"], params["max_structures"]["value"]
            )
        )

    # Random seed must be the correct number of bits.
    params["seed_bits"]["value"], errors, seed_bits_valid = check_int_on_list(
        "seed_bits",
        params["seed_bits"]["value"],
        errors,
        params["seed_bits"]["supported_values"],
    )
    if seed_bits_valid:
        params["random_seed"]["value"], errors = check_unsigned_n_bit_int(
            "random_seed",
        ...
        errors.append(
            '"random_seed" has not been verified because it must be either a 32- or 64-bit integer, '
            "but an invalid number of bits was entered."
        )
    ...
    if params["cp_stacking_sequence"]["specified"]:
        ...
        for i in range(0, len(params["cp_stacking_sequence"]["value"])):
            if (
                params["cp_stacking_sequence"]["value"][i - 1]
                == params["cp_stacking_sequence"]["value"][i]
            ):
                errors.append(
                    "The supplied close packed stacking sequence is {0}, which features repeated layers.".format(
                        "".join(params["cp_stacking_sequence"]["value"])
                    )
                )
                break

        if (
            int(params["grid_points"]["value"][2])
            % len(params["cp_stacking_sequence"]["value"])
            != 0
        ):
            errors.append(
                "The supplied close packed stacking sequence is {0}, but this is incommensurate with the {1:d} anion "
                "layers requested.".format(
                    "".join(params["cp_stacking_sequence"]["value"]),
                    params["grid_points"]["value"][2],
                )
            )
        else:
            # If stacking sequence is ok, multiply up to the number of layers
            params["cp_stacking_sequence"]["value"] *= params["grid_points"]["value"][
                2
            ] // len(params["cp_stacking_sequence"]["value"])

    # GULP files need to be the length of the number of calculations
    params["gulp_files"]["value"] = params["gulp_files"]["value"][
    ...
    if not params["restart"]["value"]:
        if params["atoms_file"]["value"].split(".")[1] != "atoms":
            errors.append(
                'the ".atoms" file is specified as "{0}", but that file does not have the ".atoms" extension.'.format(
                    params["atoms_file"]["value"]
                )
            )
        if not os.path.isfile(params["atoms_file"]["value"]):
            errors.append(
                'the ".atoms" file is specified as "{0}", but that file does not exist.'.format(
                    params["atoms_file"]["value"]
                )
            )
    ...
    # If we are restarting, we need a ".npz" file -- check the file given is valid and exists
        ...
        if params["restart_file"]["value"].split(".")[1] != "npz":
            errors.append(
                'the restart ".npz" file is specified as "{0}", but that file does not have the ".npz" extension.'.format(
                    params["restart_file"]["value"]
                )
            )
        if not os.path.isfile(params["restart_file"]["value"]):
            errors.append(
                'the restart ".npz" file is specified as "{0}", but that file does not exist.'.format(
                    params["restart_file"]["value"]
                )
            )
    ...
    if params["initial_structure_file"]["specified"]:
        if params["initial_structure_file"]["value"].split(".")[1] != "cif":
            errors.append(
                'the ".cif" file for the initial structure is specified as "{0}", but that file does not have the ".cif" extension.'.format(
                    params["initial_structure_file"]["value"]
                )
            )
        if not os.path.isfile(params["initial_structure_file"]["value"]):
            errors.append(
                'the ".cif" file for the initial structure is specified as "{0}", but that file does not exist.'.format(
                    params["initial_structure_file"]["value"]
                )
            )
    ...
    if not all(length == first_length for length in swap_lengths):
        errors.append(
            'An unequal number of weightings have been specified for the "swap_groups", "swap_groups" should be specified alone, or ALL should be given a weighting.'
        )

    elif not (
        all(length == 1 for length in swap_lengths)
        or all(length == 2 for length in swap_lengths)
    ):
    ...
    if all(length == 2 for length in swap_lengths):
        ...
        for i in range(0, len(params["swap_groups"]["value"])):
            ...
            if "/" in params["swap_groups"]["value"][i][1]:
                try:
                    params["swap_groups"]["value"][i][1] = float(
                        params["swap_groups"]["value"][i][1].split("/")[0]
                    ) / float(params["swap_groups"]["value"][i][1].split("/")[1])
                except ValueError:
                    errors.append(
                        "The weighting of the swap group {x[0]} is {x[1]}, but should be a positive number.".format(
                            x=params["swap_groups"]["value"][i]
                        )
                    )
                else:
                ...
                try:
                    params["swap_groups"]["value"][i][1] = float(
                        params["swap_groups"]["value"][i][1]
                    )
                except ValueError:
                    errors.append(
                        "The weighting of the swap group {x[0]} is {x[1]}, but it should be a positive number.".format(
                            params["swap_groups"]["value"][i]
                        )
                    )
                else:
                    if params["swap_groups"]["value"][i][1] < 0.0:
    ...
    params["vasp_settings"]["value"].update(
        {
            "kpts": params["vasp_kpoints"]["value"],
            "setups": params["vasp_pp_setups"]["value"],
        }
    )

    # If we are not updating atom geometries AND using vacancy grids, we cannot use directed swapping.
    if (
        (not params["update_atoms"]["value"])
        and (params["vacancy_grid"]["value"])
        and (params["atom_rankings"]["value"] != "random")
    ):
        errors.append(
            "Directed swapping is not supported for the use of vacancy grids when atom geometries are not updated. "
            'Please set either "update_atoms" to "True" and/or "vacancy_grid" to "False" in order to use directed '
            "swapping."
        )
...
def check_positive_float(keyword, value, errors):
    ...
    try:
        ...
        errors.append(
            '"{0}" is {1}, but should be a positive number.'.format(keyword, value)
        )
...
def check_list_positive_float(keyword, value, errors):
    ...
    try:
        ...
        errors.append(
            '"{0}" is {1}, but all values should be positive floats.'.format(
                keyword, value
            )
        )
    else:
...
def check_positive_int(keyword, value, errors):
    ...
    try:
        ...
        errors.append(
            '"{0}" is {1}, but should be a positive integer.'.format(keyword, value)
        )
    # A TypeError means that a list was inputted
    except TypeError:
...
def check_list_positive_int(keyword, value, errors):
    ...
    try:
        ...
        errors.append(
            '"{0}" is {1}, but all values should be positive integers.'.format(
                keyword, value
            )
        )
    else:
...
def check_even_int(keyword, value, errors):
    ...
    try:
        ...
        errors.append(
            '"{0}" is {1}, but should be an even integer.'.format(keyword, value)
        )
    # A TypeError means that a list was inputted
    except TypeError:
...
def check_list_even_int(keyword, value, errors):
    ...
    try:
        ...
        errors.append(
            '"{0}" is {1}, but all values should be even integers.'.format(
                keyword, value
            )
        )
    else:
...
def check_int_on_list(keyword, value, errors, allowed_ints):
    ...
    try:
        ...
        errors.append(
            '"{0}" is {1}, but should be one of the supported values: {2}'.format(
...
def check_unsigned_n_bit_int(keyword, value, errors, bits):
    ...
    try:
        ...
        errors.append(
            '"{0}" is {1}, but should be an unsigned {2:d}-bit integer.'.format(
                keyword, value, bits
            )
        )
    else:
...
def check_str_on_list(keyword, value, errors, allowed_strings):
    ...
    if value not in allowed_strings:
        errors.append(
            '"{0}" is {1}, but should only be one of the supported values: {2}'.format(
...
def check_str_list_on_list(keyword, value, errors, allowed_strings):
    ...
    for item in value:
        if item not in allowed_strings:
            errors.append(
                '"{0}" contains {1}, but should only contain the supported values: {2}'.format(
                    keyword, item, ", ".join([str(x) for x in allowed_strings])
                )
            )
            valid = False
...
def check_boolean(keyword, value, errors):
    ...
    if value.lower() in true_synonyms:
        ...
        errors.append(
            '"{0}" is {1}, but should be "True" or "False".'.format(keyword, value)
        )
...
def check_duplicates_in_list(keyword, value, errors):
    ...
    for item in value:
        if item not in uniques:
            ...
            errors.append(
                '"{0}" contains {1} more than once, but each item in this list should only appear once.'.format(
                    keyword, item
                )
            )
            valid = False
...
def check_swap_groups_valid(swap_groups, errors, main_swap_groups):
    ...
    for group in swap_group_names:
        ...
        if (
            ...
            or sorted(group_elements) != sorted(list(set(group_elements)))
            or not set(group_elements).issubset(ase_chemical_symbols)
        ):
            errors.append(
                '"swap_groups" contains "{0}", which is not a valid swap group. The main swap groups are "{1}", and custom swap groups should be in the format "[Chemical Symbol]-[Chemical Symbol]-[Chemical Symbol] . . .", with each chemical symbol appearing only once.'.format(
                    group, '", "'.join([str(x) for x in main_swap_groups])
                )
            )
            valid = False
...
def convert_to_three_element_list(keyword, value, errors):
    ...
    if len(value) > 3:
        errors.append(
            '"{0}" should be a list of up to three values, but {1:d} values have been supplied.'.format(
                keyword, len(value)
            )
        )
...
def convert_to_dict_with_yaml(keyword, value, errors):
    ...
    if value is not None:
        ...
        try:
            ...
            yaml_dict = {}
            errors.append(
                '"{0}" is "{1}". YAML failed to convert this to a valid dictionary. The contents should be syntactically valid Python.'.format(
                    keyword, value
                )
            )
